...
lexemes = [
	...
	(r'BTW[\S\s]*',								kw_line_comment),
	(r'[\s]*OBTW[\S\s]+TLDR',					kw_block_comment),	
	#(r'',                                    	kw_line_comment), 		
	(r'I[\s]+HAS[\s]+A',						kw_decl_var),
	(r'ITZ',									kw_decl_val),
	(r'IT',										kw_anon_var),
	(r'AN',										kw_conj),
	(r'SUM[\n\s]+OF',							kw_oper_add),
	(r'DIFF[\n\s]+OF',							kw_oper_sub),
	(r'PRODUKT[\s]+OF', 						kw_oper_mul),
	(r'QUOSHUNT[\s]+OF',						kw_oper_div),
	(r'MOD[\s]+OF',								kw_oper_mod),
	(r'BIGGR[\s]+OF',							kw_oper_grt),		
	(r'SMALLR[\s]+OF',							kw_oper_lst),
	(r'SMOOSH',									kw_oper_cat_start),
	(r'MMKAY?',									kw_oper_cat_end),
	(r'ALL[\s]+OF',								kw_bool_and_inf),
	(r'ANY[\s]+OF',								kw_bool_or_inf),
	(r'NOT',									kw_bool_not),
	(r'BOTH[\s]+OF',						kw_bool_and),
	(r'EITHER[\s]+OF',						kw_bool_or),
	(r'WON[\s]+OF',							kw_bool_xor),
	(r'BOTH[\s]+SAEM',						kw_bool_equ),
	...
	(r'R',									kw_assign),
	(r'O[\s]+RLY?',							kw_if_start),
	(r'YA[\s]+RLY',							kw_if_true),
	(r'MEBBE',								kw_if_other),
	(r'NO[\s]+WAI',							kw_if_false),
	(r'OIC',								kw_if_end),
